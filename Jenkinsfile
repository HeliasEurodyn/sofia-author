        ...
        dir('')
        {
            ...
            stage("Deploy")
            {
                withCredentials([usernamePassword(credentialsId: 'onenet', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')])
                {
                    ...
                    sshCommand remote: remote, command: "cd /home/engonenet/ed/onenet_for_jenkins/backend-author-container;docker-compose down"
                    sshRemove remote: remote, path: '/home/engonenet/ed/onenet_for_jenkins/backend-author-container/sofia-backend-author/sofia-0.0.1.jar'
                    sshPut remote: remote, from: './target/sofia-0.0.1.jar', into: '/home/engonenet/ed/onenet_for_jenkins/backend-author-container/sofia-backend-author/'
                    sshCommand remote: remote, command: "cd /home/engonenet/ed/onenet_for_jenkins/backend-author-container;docker-compose up --build -d"
                }
            }
